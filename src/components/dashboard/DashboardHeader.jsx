...
/**
 * Simple sticky dashboard header: MediSync branding, a mobile menu
 * toggle (the sidebar becomes a slide-in drawer below ~900px), and the
 * authenticated user's name — read from AuthContext, never decoded from
  ...
  return (
    <header className="dashboard-header">
      <div className="dashboard-header-inner">
        ...
        <Link to="/patient" className="dashboard-logo">
